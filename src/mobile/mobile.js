(() => {
    const LANGS = {
        pt: {
            ...
            mobile_footer_note: "Nada é enviado. Nada é rastreado. Tudo fica local.",
        ...
        en: {
            ...
            mobile_footer_note: "Nothing is sent. Nothing is tracked. Everything stays local.",
        ...
        es: {
            ...
            mobile_export_copy: "COPIAR B64",
            mobile_footer_note: "Nada se envía. Nada se rastrea. Todo queda local.",
        ...
        fr: {
            ...
            mobile_footer_note: "Rien n'est envoyé. Rien n'est suivi. Tout reste local.",
